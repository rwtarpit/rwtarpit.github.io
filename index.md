...
<ul>
<li><strong><a href="{{ site.baseurl }}{% post_url 2026-01-16-bpe %}">Building a BPE Tokenizer from Scratch</a></strong> — A deep dive into subword tokenization...</li>
</ul>
...
<h2 style="margin-top:2.5rem;">🌍 Open Source Contributions</h2>
