...
#UNICODE
ASCII can represent only 256 characters (general english characters and symbols) and takes 1 byte of memory. To extend representation in multiple languages UTF was made. UTF-8 (most used format of UTF) uses 4 bytes to represent a character. These 4 bytes represents all characters of major languages.
